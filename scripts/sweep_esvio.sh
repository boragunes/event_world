...
OUT="$ROOT/results/esvio/vector/$SEQ"; GT="$ROOT/data/vector/$SEQ/${SEQ}_gt_txt.txt"
SCR=/tmp/claude-1000/-home-ogam-event-world/7cbb5a11-e588-4499-bdef-4fa414d4f124/scratchpad
...
for v in "${ORDER[@]}"; do
  ...
  CONFIG_OVERRIDES="${V[$v]}" FIX_CALIB=1 bash "$ROOT/scripts/run_and_eval.sh" vector "$SEQ" \
