...
| [ESVO2](esvo2/) | stereo events + IMU (direct, classical) | VECtor — [report](docs/validation/esvo2_vector.md) | inputs via **upstream's own repacking tool** (A/B-proven decisive); **desk-normal reproduced exactly** (16.42 vs 16.47), robot/hdr-normal ≈ paper; corner-slow/sofa-normal/robot-fast **not reproduced** (match authors' issue-#11 admission); **all fast seqs diverge in both config tiers** |
