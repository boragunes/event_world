...
| [DEIO](deio/) | monocular events + IMU (deep) | VECtor — [report](docs/validation/deio_vector.md) | our run, SE3 metric, vs DEIO paper Table IV; default config; our own trajectories only |
